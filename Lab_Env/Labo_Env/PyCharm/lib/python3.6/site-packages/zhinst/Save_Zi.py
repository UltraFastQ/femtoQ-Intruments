...
def run_example(device_id, settings_file_path=None, daq = None, device = None):
    """
    ...
    """
    if daq != None and device != None:

        timestr = time.strftime("%Y%m%d_%H%M")
        filename_noext = timestr + '_zi_settings'  # Change this to the filename you want to save.

...
class MainFrame(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.Frame = [
            HomePage(self),
            ZurichFrame(self, mainf=self),
            Mono_Physics(self, mainf=self),
        ...
        winmenu.add_command(
            label="Zurich",
            underline=0,
            command=lambda: self.frame_switch(self.Frame[1]),
        )
        winmenu.add_command(
            label="Mono+PhysL",
            underline=0,
            command=lambda: self.frame_switch(self.Frame[2]),
        )
        winmenu.add_command(
            label="Spectro.",
            underline=0,
            command=lambda: self.frame_switch(self.Frame[3]),
        )
        winmenu.add_command(
            label="Experiment",
            underline=0,
...
class HomePage(tk.Frame):
    def __init__(self, parent):
        ...
        directory = Path.cwd()
        image = tk.PhotoImage(
            master=self, file=directory / "FemtoQ_logo_white-bg.png")
...
class ZurichFrame(tk.Frame):
    def __init__(self, parent, mainf=None):
        ...
        def connectionframe():
            ...
            connect_e = tk.Entry(
                connectframe, textvariable=connect_var, width=8)
            connectbutton = tk.Button(
                connectframe,
                text="Connect",
                command=lambda: self.Zurich.connect_device(
                    connect_var.get(), exp_dependencie=True
                ),
            )
        ...
        def inputframe():
            ...
            input1rangevalue = tk.Entry(
                inputframe, textvariable=input1range_var, width=4
            )
            input1autorange = tk.Button(
                inputframe, text="ici", width=2, height=1)
            input1scaling = tk.Label(inputframe, text="Scale")
            input1scaleratio_var = tk.DoubleVar()
            input1scaleratio_var.set(1)
            input1scaleratio = tk.Entry(
                inputframe, textvariable=input1scaleratio_var, width=4
            )
            input1scaleunit_var = tk.StringVar()
            input1scaleunit_var.set("V")
            input1scaleunit = tk.Entry(
                inputframe, textvariable=input1scaleunit_var, width=2
            )
            input1ac = tk.Label(inputframe, text="AC")
            input1ac_var = tk.StringVar()
            input1ac_var.set("Disabled")
            input1acbutton = tk.Checkbutton(
                inputframe,
                variable=input1ac_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            input150button = tk.Checkbutton(
                inputframe,
                variable=input150_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            input2rangevalue = tk.Entry(
                inputframe, textvariable=input2range_var, width=4
            )
            input2autorange = tk.Button(
                inputframe, text="ici", width=2, height=1)
            input2scaling = tk.Label(inputframe, text="Scale")
            input2scaleratio_var = tk.DoubleVar()
            input2scaleratio_var.set(1)
            input2scaleratio = tk.Entry(
                inputframe, textvariable=input2scaleratio_var, width=4
            )
            input2scaleunit_var = tk.StringVar()
            input2scaleunit_var.set("V")
            input2scaleunit = tk.Entry(
                inputframe, textvariable=input2scaleunit_var, width=2
            )
            input2ac = tk.Label(inputframe, text="ac")
            input2ac_var = tk.StringVar()
            input2ac_var.set("Disabled")
            input2acbutton = tk.Checkbutton(
                inputframe,
                variable=input2ac_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            input250button = tk.Checkbutton(
                inputframe,
                variable=input250_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            self.create_bind(
                [input1rangevalue, input1range_var, "double", "/sigins/0/range"],
                type_="entry",
            )
            self.create_bind(
                [
                    input1scaleratio,
                    [input1scaleratio_var, input1scaleunit_var],
                    "tension",
                    "/sigins/0/scaling",
                ],
                type_="entry",
            ...
            self.create_bind(
                [input2rangevalue, input2range_var, "double", "/sigins/1/range"],
                type_="entry",
            )
            self.create_bind(
                [
                    input2scaleratio,
                    [input2scaleratio_var, input2scaleunit_var],
                    "tension",
                    "/sigins/1/scaling",
                ],
                type_="entry",
            ...
            self.create_bind(
                list_=[input1acbutton, input1ac_var, "T_F", "/sigins/0/ac"],
                type_="check",
            )
            self.create_bind(
                list_=[input150button, input150_var, "T_F", "/sigins/0/imp50"],
                type_="check",
            )
            self.create_bind(
                [input2acbutton, input2ac_var, "T_F", "/sigins/1/ac"], type_="check"
            )
            self.create_bind(
                [input250button, input250_var, "T_F", "/sigins/1/imp50"], type_="check"
            )
            self.create_bind(
                [input1autorange, "/sigins/0/autorange"], type_="button")
            self.create_bind(
                [input2autorange, "/sigins/1/autorange"], type_="button")
        ...
        def outputframe():
            ...
            output1rangevalue = tk.Entry(
                outputframe, textvariable=output1range_var, width=6
            )
            output1autorange = tk.Button(
                outputframe, text="ici", width=2, height=1)
            output1offset = tk.Label(outputframe, text="Offset(V)")
            output1offset_var = tk.DoubleVar()
            output1offset_var.set(0)
            output1offset_entry = tk.Entry(
                outputframe, textvariable=output1offset_var, width=6
            )
            output1on_var = tk.StringVar()
            output1on_var.set("Disabled")
            output1on = tk.Label(outputframe, text="On")
            output1onbutton = tk.Checkbutton(
                outputframe,
                variable=output1on_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            output150button = tk.Checkbutton(
                outputframe,
                variable=output150_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            output2rangevalue = tk.Entry(
                outputframe, textvariable=output2range_var, width=6
            )
            output2autorange = tk.Button(
                outputframe, text="ici", width=2, height=1)
            output2offset = tk.Label(outputframe, text="Offset(V)")
            output2offset_var = tk.DoubleVar()
            output2offset_var.set(0)
            output2offset_entry = tk.Entry(
                outputframe, textvariable=output2offset_var, width=6
            )
            output2on = tk.Label(outputframe, text="On")
            output2on_var = tk.StringVar()
            output2on_var.set("Disabled")
            output2onbutton = tk.Checkbutton(
                outputframe,
                variable=output2on_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            self.create_bind(
                [output1rangevalue, output1range_var,
                    "double", "/sigouts/0/range"],
                type_="entry",
            )
            self.create_bind(
                [output1offset_entry, output1offset_var,
                    "double", "/sigouts/0/offset"],
                type_="entry",
            )
            self.create_bind(
                [output2rangevalue, output2range_var,
                    "double", "/sigouts/1/range"],
                type_="entry",
            )
            self.create_bind(
                [output2offset_entry, output2offset_var,
                    "double", "/sigouts/1/offset"],
                type_="entry",
            )
            self.create_bind(
                [
                    ...
                    [
                        "output",
                        "/sigouts/0/on",
                        ["/sigouts/0/enables", "/sigouts/0/amplitudes"],
                    ],
                ],
                type_="check",
            )
            self.create_bind(
                [output150button, output150_var, "T_F", "/sigouts/0/imp50"],
                type_="check",
            )
            self.create_bind(
                [
                    ...
                    [
                        "output",
                        "/sigouts/1/on",
                        ["/sigouts/1/enables", "/sigouts/1/amplitudes"],
                    ],
                ],
                type_="check",
            )
            self.create_bind(
                [output250button, output250_var, "T_F", "/sigouts/1/imp50"],
                type_="check",
            )

            self.create_bind(
                [output1autorange, "/sigouts/0/autorange"], type_="button")
            self.create_bind(
                [output2autorange, "/sigouts/1/autorange"], type_="button")

        def demodulatorframe():

            # Demodulator
            demoframe = ttk.Labelframe(self, text="Demodulator")
            demoframe.grid(row=4, column=0, rowspan=4,
            ...
            demo2sinc = tk.Checkbutton(
                demoframe,
                variable=demo2sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo3sinc = tk.Checkbutton(
                demoframe,
                variable=demo3sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo4sinc = tk.Checkbutton(
                demoframe,
                variable=demo4sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo5sinc = tk.Checkbutton(
                demoframe,
                variable=demo5sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo6sinc = tk.Checkbutton(
                demoframe,
                variable=demo6sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo7sinc = tk.Checkbutton(
                demoframe,
                variable=demo7sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            demo8sinc = tk.Checkbutton(
                demoframe,
                variable=demo8sinc_var,
                onvalue="Enabled",
                offvalue="Disabled",
            )
            ...
            osc_list = [
                [demo1osc, demo1osc_var],
                [demo2osc, demo2osc_var],
                [demo3osc, demo3osc_var],
                [demo4osc, demo4osc_var],
                [demo5osc, demo5osc_var],
                [demo6osc, demo6osc_var],
                [demo7osc, demo7osc_var],
                [demo8osc, demo8osc_var],
            ]

            for i in range(1, 9):
                self.create_bind(
                    [osc_list[i - 1], "int",
                        "/demods/{}/oscselect".format(i - 1)],
                    type_="spin",
                )

            harm_list = [
                [demo1harm, demo1harm_var],
                [demo2harm, demo2harm_var],
                [demo3harm, demo3harm_var],
                [demo4harm, demo4harm_var],
                [demo5harm, demo5harm_var],
                [demo6harm, demo6harm_var],
                [demo7harm, demo7harm_var],
                [demo8harm, demo8harm_var],
            ]

            for i in range(1, 9):
                self.create_bind(
                    [harm_list[i - 1], "int",
                        "/demods/{}/harmonic".format(i - 1)],
                    type_="spin",
                )

            phase_list = [
                [demo1phase, demo1phase_var],
                [demo2phase, demo2phase_var],
                [demo3phase, demo3phase_var],
                [demo4phase, demo4phase_var],
                [demo5phase, demo5phase_var],
                [demo6phase, demo6phase_var],
                [demo7phase, demo7phase_var],
                [demo8phase, demo8phase_var],
            ]
            ...
            order_list = [
                [demo1order, demo1order_var],
                [demo2order, demo2order_var],
                [demo3order, demo3order_var],
                [demo4order, demo4order_var],
                [demo5order, demo5order_var],
                [demo6order, demo6order_var],
                [demo7order, demo7order_var],
                [demo8order, demo8order_var],
            ]

            for i in range(1, 9):
                self.create_bind(
                    [order_list[i - 1], "int",
                        "/demods/{}/order".format(i - 1)],
                    type_="spin",
                )

            bw3db_list = [
                [demo1bw3dbe, [demo1bw3db_var, demo1order_var]],
                [demo2bw3dbe, [demo2bw3db_var, demo2order_var]],
                [demo3bw3dbe, [demo3bw3db_var, demo3order_var]],
                [demo4bw3dbe, [demo4bw3db_var, demo4order_var]],
                [demo5bw3dbe, [demo5bw3db_var, demo5order_var]],
                [demo6bw3dbe, [demo6bw3db_var, demo6order_var]],
                [demo7bw3dbe, [demo7bw3db_var, demo7order_var]],
                [demo8bw3dbe, [demo8bw3db_var, demo8order_var]],
            ]
            for i in range(1, 9):
                self.create_bind(
                    [
            ...
            sinc_list = [
                [demo1sinc, demo1sinc_var],
                [demo2sinc, demo2sinc_var],
                [demo3sinc, demo3sinc_var],
                [demo4sinc, demo4sinc_var],
                [demo5sinc, demo5sinc_var],
                [demo6sinc, demo6sinc_var],
                [demo7sinc, demo7sinc_var],
                [demo8sinc, demo8sinc_var],
            ]
            ...
            datae_list = [
                [demo1datae, demo1datae_var],
                [demo2datae, demo2datae_var],
                [demo3datae, demo3datae_var],
                [demo4datae, demo4datae_var],
                [demo5datae, demo5datae_var],
                [demo6datae, demo6datae_var],
                [demo7datae, demo7datae_var],
                [demo8datae, demo8datae_var],
            ]
        ...
        def oscframe():
            ...
            self.create_bind(
                [osc1_e, osc1_evar, "double_str2db", "/oscs/0/freq"], type_="entry"
            )
            self.create_bind(
                [osc2_e, osc2_evar, "double_str2db", "/oscs/0/freq"], type_="entry"
            )
        ...
        def graphicframe():
            ...
            class Scope:
                def __init__(self, parent_g, parent_o, parent_):
                    self.graph = GraphFrame(
                        parent_g,
                        axis=["Time", "Voltage"],
                        class_=Zurich_Instrument.Scope,
                        frame_class=parent_,
                    )
                    self.option = ScopeOptionFrame(
                        parent_o, self.graph, frame_class=parent_
                    )
            ...
            class BoxCar:
                def __init__(self, parent_g, parent_o, parent_):
                    self.graph = GraphFrame(
                        parent_g,
                        axis=["Time", "Voltage"],
                        class_=Zurich_Instrument.Boxcar,
                        frame_class=parent_,
                    )
                    self.option = BoxOptionFrame(
                        parent_o, self.graph, frame_class=parent_
                    )
            ...
            class Plotter:
                def __init__(self, parent_g, parent_o, parent_):
                    self.graph = GraphFrame(
                        parent_g,
                        axis=["Time", "Voltage"],
                        class_=Zurich_Instrument.Plotter,
                        frame_class=parent_,
                    )
                    self.option = PlotterOptionFrame(
                        parent_o, self.graph, frame_class=parent_
                    )

            class GraphFrame(tk.Frame):
                def __init__(
                    self, parent=None, axis=None, class_=None, frame_class=None
                ):
                    size = [7, 4]
                    tk.Frame.__init__(self, parent)
                    self.grid_columnconfigure(0, weight=1)
                    self.grid_rowconfigure(0, weight=1)
                    self.Graph = Graphic.GraphicFrame(
                        self, axis_name=axis, figsize=size
                    )
            ...
            class ScopeOptionFrame(tk.Frame):
                ...
                def __init__(self, parent, assigned_graph, frame_class):
                    def off_on(state):
                        ...
                        state = state.get()
                        if state == "enable":
                            frame_class.Zurich.add_subscribed(
                                "/scopes/", assigned_graph.class_, assigned_graph.Graph
                            )
                        elif state == "disable":
                    ...
                    run = tk.Checkbutton(
                        self,
                        text="Enable",
                        command=lambda: graph.class_.enable_scope(0, run_var),
                        onvalue="enable",
                        offvalue="disable",
                        variable=run_var,
                    )
                    ...
                    lenght_entry = tk.Entry(
                        self, width=12, textvariable=lenght_entry_var
                    )
                    ...
                    cinput_sig["value"] = (
                        "Input 1", "Input 2", "Trig. 1", "Trig. 2")
                    cinput_sig.current(0)
                    cinput_sig.grid(row=4, column=3,
                                    columnspan=2, sticky="nsew")
                    # This is only for a given scope. Work need to be done to add the second scope
                    frame_class.create_bind(
                        [mode_combo, "combobox", "/scopes/0/"], type_="combo"
                    )
                    frame_class.create_bind(
                        [sample_combo, "combobox", "/scopes/0/time"], type_="combo"
                    )
                    frame_class.create_bind(
                        [cinput_sig, "combobox", "/scopes/0/channels/0/inputselect"],
                        type_="combo",
                    )
                    frame_class.create_bind(
                        [lenght_entry, lenght_entry_var,
                            "int", "/scopes/0/length"],
                        type_="entry",
                    )
                    ...
                    trigger_label.grid(
                        row=0, column=6, columnspan=2, sticky="nsew")
                    trig_var = tk.StringVar()
                    trig_var.set("disable")
                    trig_enable = tk.Checkbutton(
                        self,
                        text="Enable",
                        variable=trig_var,
                        onvalue="enable",
                    ...
                    tin_sig = ttk.Combobox(
                        self, textvariable="", width=8, state="readonly"
                    )
                    tin_sig["value"] = (
                        "Input 1", "Input 2", "Trig. 1", "Trig. 2")
                    tin_sig.current(0)
                    ...
                    slope_sig = ttk.Combobox(
                        self, textvariable="", width=8, state="readonly"
                    )
                    slope_sig["value"] = ("None", "Rise", "Rise", "Both")
                    slope_sig.current(1)
                    slope_sig.grid(row=2, column=7,
                                   columnspan=2, sticky="nsew")
                    trig_enable.config(
                        command=lambda: assigned_graph.class_.enable_trigger(
                            scope=0, trigger=tin_sig, variable_=trig_var
                        )
                    )
                    ...
                    advanced_label.grid(
                        row=0, column=10, columnspan=3, sticky="nsew")
                    fft_label = tk.Label(self, text="FFT Window")
                    fft_label.grid(row=1, column=10, sticky="nw")
                    fft_combo = ttk.Combobox(
                        self, textvariable="", width=8, state="disable"
                    )
                    fft_combo["value"] = (
                        "Rectangular",
                        "Hann",
                    ...
                    math_label.grid(row=0, column=14,
            ...
            class BoxOptionFrame(tk.Frame):
                def __init__(self, parent, assigned_graph, frame_class):
                    ...
                    mode_combo = ttk.Combobox(
                        self, width=8, textvariable="", state="readonly"
                    )
                    ...
                    mode_combo.bind(
                        "<<ComboboxSelected>>",
                        lambda e: graph.class_.phase_and_time(mode_combo),
                    )
                    ...
                    width_entry = tk.Entry(
                        self, width=6, textvariable=width_entry_var)
                    ...
                    sample_entry = tk.Entry(
                        self, width=6, textvariable=sample_entry_var
                    )
                    ...
                    ave_entry_var.set(1)
                    ave_entry = tk.Entry(
                        self, width=8, textvariable=ave_entry_var)
                    ...
                    rate_entry = tk.Entry(
                        self, width=6, textvariable=rate_entry_var)
                    rate_entry.grid(row=3, column=7, sticky="nsew")

                    s3 = ttk.Separator(self, orient="vertical")
                    s3.grid(row=0, column=9, rowspan=4, sticky="nsew", padx=2)
                    math_label = tk.Label(self, text="Math")
                    math_label.grid(row=0, column=10,
                                    columnspan=3, sticky="nsew")
                    # Button configuration for this section
                    run.config(
                        command=lambda: graph.class_.enable_boxcar(
                            pwa_input=pwa_combo, box_input=box_combo, variable=run_var
                        )
                    )
                    show.config(command=lambda: off_on(show_var))
                    frame_class.create_bind(
                        [pwa_combo, "combobox", "/inputpwas/0/inputselect"],
                        type_="combo",
                    )
                    frame_class.create_bind(
                        [box_combo, "combobox", "/boxcars/0/inputselect"], type_="combo"
                    )
                    frame_class.create_bind(
                        [
                            width_entry,
                    ...
                    frame_class.create_bind(
                        [ave_entry, ave_entry_var, "int", "/boxcars/0/periods"],
                        type_="entry",
                    )
                    frame_class.create_bind(
                        [
            ...
            class PlotterOptionFrame(tk.Frame):
                def __init__(self, parent, assigned_graph, frame_class):
                    ...
                    preset_box = tk.Listbox(
                        self, listvariable=preset_options, height=3)
                    ...
                    setting_label.grid(
                        row=0, column=6, columnspan=3, sticky="nsew")
                    ...
                    wtime_e.bind(
                        "<Return>",
                        lambda e: assigned_graph.class_.change_axislim(
                            wtime_evar),
                    )
                    ...
                    run.config(
                        command=lambda: graph.class_.update_plotter(
                            graph, run_var)
                    )

            option_g = ttk.Combobox(
                self, textvariable="", state="readonly", width=15)
            ...
            option_g.bind(
                "<<ComboboxSelected>>",
                lambda x: frame_switch(frames_option_g, option_g.get()),
            )
            ...
            option_o.bind(
                "<<ComboboxSelected>>",
                lambda x: frame_switch(frames_option_o, option_o.get()),
            )
    ...
    def create_bind(self, list_=None, type_=None):
        ...
        if type_ == "entry":
            tk_item[0].bind(
                "<Return>",
                lambda e: function_(
                    value=tk_item[1], type_=tk_item[2], setting_line=tk_item[3]
                ),
            )
        elif type_ == "check":
            tk_item[0].config(
                command=lambda: function_(
                    value=tk_item[1], type_=tk_item[2], setting_line=tk_item[3]
                )
            )
        elif type_ == "spin":
            tk_item[0][0].config(
                command=lambda: function_(
                    value=tk_item[0][1], type_=tk_item[1], setting_line=tk_item[2]
                )
            )
        elif type_ == "combo":
            tk_item[0].bind(
                "<<ComboboxSelected>>",
                lambda e: function_(
                    value=tk_item[0], type_=tk_item[1], setting_line=tk_item[2]
                ),
            )
        elif type_ == "button":
            tk_item[0].config(
                command=lambda: function_(
                    value=None, type_=None, setting_line=tk_item[1]
                )
            )
...
class SpectroFrame(tk.Frame):
    def __init__(self, parent, mainf=None):
        ...
        self.graph = Graphic.GraphicFrame(
            graph_frame, axis_name=["Wavelength", "Intensity"], figsize=[9, 6]
        )
        ...
        inte.bind(
            "<Return>", lambda e: self.Spectro.adjust_integration_time(
                self.inte_var)
        )
        ...
        dark_spectrum = tk.Checkbutton(
            option_frame,
            text="Dark Spectrum substraction:",
            variable=dark_spectrum_var,
            command=lambda: self.Spectro.enable_darkspectrum(
                dark_spectrum_var, dark_b),
            onvalue="enable",
            offvalue="disable",
        )
        ...
        eff = tk.Checkbutton(
            option_frame,
            text="Detector efficiencie divider:",
            variable=eff_var,
        ...
        logascale = tk.Checkbutton(
            option_frame,
            text="Logarithmic scale:",
            variable=logascale_var,
        ...
        dual_plotting = tk.Checkbutton(
            option_frame,
            text="Wavalenght + FFT:",
            variable=dual_plotting_var,
            command=lambda: self.Spectro.switch_graphics(
                dual_plotting_var, graph_frame
            ),
            onvalue="enable",
            offvalue="disable",
        )
        ...
        autofft = tk.Checkbutton(
            option_frame,
            text="Autoscale fft:",
            variable=autofft_var,
        ...
        fwhm_var.set(0)
        fwhm_e = tk.Entry(
            option_frame, textvariable=fwhm_var, width=6, state="disabled"
        )
    ...
    def measure(self, button, variable, dual_p, average, fwhm, click=False):
        ...
        if click:
            if variable.get() == "disable":
                ...
                self.after(t, self.measure, button,
                           variable, dual_p, average, fwhm)
...
class Ueye_Frame(tk.Frame):
    def __init__(self, parent, mainf=None):
        ...
        graph_frame.grid_rowconfigure(0, weight=1)
        graph_frame.grid_columnconfigure(0, weight=1)
        self.graph = Graphic.UyeGraphFrame(
            graph_frame,
            axis_name=["Position [$\mu$m]", "Position [$\mu$m]"],
            figsize=[8, 6],
        )
        self.bind("<Configure>", self.graph.change_dimensions)
        ...
        live_b = tk.Button(
            option_frame, text="Live", width=5, command=lambda: self.live_update()
        )
        ...
        fwhmy = tk.Entry(
            option_frame, textvariable=fwhmy_var, state="disabled", width=6
        )
        fwhmy.grid(row=11, column=2, sticky="nw")
        fwhmx = tk.Entry(
            option_frame, textvariable=fwhmx_var, state="disabled", width=6
        )
        ...
        gwaisty = tk.Entry(
            option_frame, textvariable=gwaisty_var, state="disabled", width=6
        )
        gwaisty.grid(row=13, column=2, sticky="nw")
        gwaistx = tk.Entry(
            option_frame, textvariable=gwaistx_var, state="disabled", width=6
        )
        gwaistx.grid(row=14, column=2, sticky="nw")

        tk.Label(option_frame, text="Highest pixel count :").grid(
            row=15, column=0, sticky="nw", columnspan=2
        )
...
class Experiment(ttk.LabelFrame):
    def __init__(self, parent, mainf=None):
        ...
        experiment_name.bind(
            "<<ComboboxSelected>>",
            lambda e: frame_switch(self.experiment_dict,
                                   experiment_name.get()),
        )
        ...
        def create_layout(name=None, function_=None, option=None, graph=None):
            ...
            if type(name) == str:
                ...
                self.experiment_dict[name] = Experiment_file.CreateLayout(
                    mainf=self.mainf,
                    window=self,
                    tools_names=option,
                    graph_names=graph,
